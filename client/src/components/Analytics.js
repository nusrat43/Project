...
// import reportWebVitals from './../../../project/src/reportWebVitals';

const Analytics = ({ allTransection }) => {

    //Category
    const categories = ["salary", "tip","teaching","social-media","college fee", "hostel fee", "picnic", "project", "grocery", "food", "movie", "bills", "medical", "fee", "tax"];
